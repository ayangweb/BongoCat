...
手柄不属于此 standalone tap spike 的实现范围；正式产品的 gilrs/IOHID 接线、mapping、
generation、Reset 重播与已知 fork 阻塞见 ADR-0066 和 `bongocat-platform::gilrs_gamepad`。旧
GameController framework owner 及其无设备 smoke 已从当前树删除。
