...
Phase 0 以 **Cubism 5 SDK for Native R5**（`5-r.5`，2026-04-02）作为唯一验证版本。该版本对应 Core `06.00.0001`。
...
| Samples 中的 Framework submodule | 同上                                                                            | commit `c5cc765a885ac95e07fde93f300fab019f8c11f7`              |
| Core header 与平台二进制         | [官方 Native SDK 下载页](https://www.live2d.com/en/sdk/download/native/)        | `CubismSdkForNative-5-r.5.zip`；实际 SHA-256 待合法下载后记录  |
...
1. 维护者在官方页面自行阅读并接受当时有效的两份协议，下载 `CubismSdkForNative-5-r.5.zip`。
