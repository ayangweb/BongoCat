...
| macOS tester       | 在目标 macOS 版本补齐 Apple 拼音/物理键盘、TCC deny/grant/revoke、锁屏/睡眠/用户切换、显示器和物理 GameController 矩阵 | commit、OS、CPU/GPU、权限前后状态和匿名计数                    | 权限或输入不可恢复时触发 GPUI/input 选型复评             |
