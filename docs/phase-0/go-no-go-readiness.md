...
| Cubism source/license    | Native `5-r.5`/Core `06.00.0001`、archive/header/Core artifact SHA-256、官方 Framework/Samples tag commit 和目标 artifact 路径已固定；SDK 保持仓库外                                                                                                                                                                                                                                                                                                                                                                                 | 第二来源复核、书面发布授权、Rust Framework 实现边界、notice/redistribution 结论                                                                                     | stable 发布 blocker；不阻止本地实现                       |
