...
| GPUI settings            | GPUI 0.2.2 默认 shader、`.app`、主题、文本状态 contract、runtime bridge、AX/UIA 最小 tree/action 和窗口重开已通过；macOS modal dialog/焦点陷阱/语义子树 smoke 通过                                                                                                                                                      | 真实中文 IME、VoiceOver/Narrator、error/loading 宣读、tooltip 真实 hover/朗读、完整菜单、Windows dialog CI/DPI         | P0 blocker；ADR-0009 保持 Proposed                        |
