...
状态（2026-08-28）：已建立 v1 input/expected schema、7 组输入序列和规范化结果；8 个文档通过 Draft 2020-12 校验及跨文件一致性检查。物理键全集、动作/表情场景和旧版人工确认仍未完成。
...
2. [x] `P0-FIXTURE-V1`：提交 input/expected schema、7 组核心输入 fixture 和跨文件 validator。
