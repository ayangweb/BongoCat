...
- 2026-08-30 的 macOS `.app` smoke 读取 Reset 的 help text，并验证打开确认框后只暴露 modal `AlertDialog` 子树、初始 Cancel 焦点、键盘关闭与语义树恢复；同一实现的 Windows UI Automation dialog 门禁等待本批 CI 结果；
